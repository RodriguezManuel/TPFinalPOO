...
public enum Figure {
	...
	F8(new Point[]{ new Point(0,-1), new Point(1,0), new Point(2,0), new Point(0,1)}, 92, WrappedCandy.class),
	...
	F18(new Point[]{ new Point(0,-2), new Point(0,-1), new Point(-2,0), new Point(-1,0)}, 195, WrappedCandy.class),
	F19(new Point[]{ new Point(0,-1), new Point(-2,0), new Point(-1,0), new Point(0,1)}, 83, WrappedCandy.class),
